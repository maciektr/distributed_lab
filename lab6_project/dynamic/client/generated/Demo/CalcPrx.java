...
//    }
//
//    default String op(A a1, short b1)
//    {
//        return op(a1, b1, com.zeroc.Ice.ObjectPrx.noExplicitContext);
//    }
//
//    default String op(A a1, short b1, java.util.Map<String, String> context)
//    {
//        return _iceI_opAsync(a1, b1, context, true).waitForResponse();
//    }
//
//    default java.util.concurrent.CompletableFuture<java.lang.String> opAsync(A a1, short b1)
//    {
//        return _iceI_opAsync(a1, b1, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
//    }
//
//    default java.util.concurrent.CompletableFuture<java.lang.String> opAsync(A a1, short b1, java.util.Map<String, String> context)
//    {
...
//     * @return -
//     **/
//    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_opAsync(A iceP_a1, short iceP_b1, java.util.Map<String, String> context, boolean sync)
//    {
//        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "op", null, sync, null);
//        f.invoke(true, context, null, ostr -> {
